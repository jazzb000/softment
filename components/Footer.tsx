...
export function Footer() {
  ...
  return (
    <div
      ...
      data-name="푸터"
    >
      <div className="box-border content-stretch flex flex-col items-start justify-start relative shrink-0 w-full max-w-[500px] sm:max-w-[448px] md:max-w-[890px] xl:max-w-[890px] min-w-0">
        <div
