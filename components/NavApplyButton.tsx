...
export function NavApplyButton({ onClick, disabled = false }: NavApplyButtonProps) {
  ...
  return (
    ...
    >
      <div className="font-['Pretendard'] font-semibold leading-[0] not-italic relative shrink-0 text-[#ffffff] text-[12px] lg:text-[14px] text-center lg:text-left text-nowrap pointer-events-none">
        <p className="block leading-[1.4] whitespace-pre">이용 신청하기</p>
      </div>
    </button>
  );
}