        ...
        <div className="flex flex-row items-center justify-center relative size-full">
          <div className="box-border content-stretch flex flex-row items-center justify-center pb-[0px] pt-[60px] px-[20px] md:px-[100px] xl:px-[390px] relative w-full">
            <div className="box-border content-stretch flex flex-col gap-[32px] h-[300px] md:h-[400px] items-center justify-center p-[0px] relative shrink-0 w-full md:w-[260px]">
              <div className="font-['Pretendard'] font-bold leading-[0] min-w-full not-italic relative shrink-0 text-[#ffffff] text-[28px] md:text-[48px] text-center md:text-left" style={{ width: "min-content" }}>
          ...
          <FeatureGrid columns={2} gap="lg">
            ...
            <div className="box-border content-stretch flex flex-col gap-[60px] md:gap-[90px] items-start justify-start p-[0px] relative w-full">
              <div className="box-border content-stretch flex flex-col items-start justify-start p-[0px] relative shrink-0">
                <div className="font-['Pretendard'] font-semibold leading-[0] min-w-full not-italic relative shrink-0 text-[#2272eb] text-[28px] md:text-[48px] text-left">
                ...
                <div className="box-border content-stretch flex flex-row gap-[8px] items-center justify-center pb-[0px] pt-[8px] px-[0px] relative shrink-0">
                  <div className="font-['Pretendard'] font-semibold leading-[0] not-italic relative shrink-0 text-[#4e5968] text-[16px] md:text-[20px] text-left">
              ...
              <div className="box-border content-stretch flex flex-row gap-[12px] items-center justify-start p-[0px] relative shrink-0">
                <div className="font-['Pretendard'] font-semibold leading-[0] not-italic relative shrink-0 text-[#d1d6db] text-[28px] md:text-[48px] text-left text-nowrap">
                ...
                <div className="bg-[rgba(49,130,246,0.16)] box-border content-stretch flex flex-row items-center justify-center px-[8px] py-[0px] relative rounded-[100px] shrink-0">
                  <div className="font-['Pretendard'] font-semibold leading-[0] not-italic relative shrink-0 text-[#1b64da] text-[12px] text-left text-nowrap">
            ...
            <div className="box-border content-stretch flex flex-col gap-[32px] items-start justify-start p-[0px] relative w-full">
              ...
              <div className="box-border content-stretch flex flex-row gap-[16px] items-end justify-start p-[0px] relative shrink-0">
                <div className="box-border content-stretch flex flex-col gap-[10px] items-center justify-start overflow-clip p-[0px] relative shrink-0 w-[120px]">
                  <div className="font-['Pretendard'] font-semibold leading-[0] not-italic relative shrink-0 text-[#6b7684] text-[17px] text-left text-nowrap">
                  ...
                  <div className="font-['Pretendard'] font-normal leading-[0] not-italic relative shrink-0 text-[#4e5968] text-[15px] text-left text-nowrap">
                    <p className="block leading-[1.6] whitespace-pre">PG 업계 평균</p>
                  </div>
                </div>
                <div className="box-border content-stretch flex flex-col gap-[10px] items-center justify-start overflow-clip p-[0px] relative shrink-0 w-[120px]">
                  <div className="font-['Pretendard'] font-semibold leading-[0] not-italic relative shrink-0 text-[#3182f6] text-[17px] text-left text-nowrap">
        ...
        <PageSection spacing="lg" id="pricing">
          <div className="flex flex-col gap-[24px] w-full">
            <div className="h-[47px] relative shrink-0 w-full">
              <div 
                className="absolute font-['Pretendard'] font-semibold inset-0 leading-[0] not-italic text-[24px] md:text-[36px] text-left cursor-pointer transition-colors duration-200"
            ...
            <div className="box-border content-stretch grid grid-cols-1 lg:grid-cols-2 gap-[16px] items-stretch w-full">
              <div className="relative rounded-2xl border border-[#d1d6db]">
                <div className="flex flex-col lg:flex-row gap-[12px] lg:gap-[32px] items-start lg:items-center p-[16px] lg:p-[32px] w-full">
                  <div className="font-['Pretendard'] font-bold leading-[0] not-italic text-[#3182f6] text-[20px] lg:text-[22px] xl:text-[24px] text-left text-nowrap">
                  ...
                  <div className="flex flex-row gap-[8px] items-center text-[20px] lg:text-[22px] xl:text-[24px] text-left">
                    <div className="font-['Pretendard'] font-bold text-[#333d4b]">
                      <p className="block leading-[1.6] text-nowrap whitespace-pre">220,000원</p>
                    </div>
                    <div className="font-['Pretendard'] font-semibold text-[#6b7684]">
          ...
          <div className="flex flex-col gap-[40px] w-full">
            ...
            <div className="box-border content-stretch flex flex-col items-start justify-start w-full border-t border-[#e5e8eb]">
              ...
              <div className="grid grid-cols-[1fr_auto] lg:grid-cols-[248px_1fr] gap-[8px] py-[20px] lg:py-[24px] w-full border-b border-[#e5e8eb]">
                <div className="font-['Pretendard'] font-normal leading-[0] not-italic text-[#4e5968] text-[20px] text-left text-nowrap pr-[24px]"> 
                  <p className="block leading-[1.6] whitespace-pre">신용∙체크카드</p>
                </div>
                <div className="font-['Pretendard'] font-semibold leading-[0] not-italic text-[#4e5968] text-[20px] text-right lg:text-left">
              ...
              <div className="grid grid-cols-[1fr_auto] lg:grid-cols-[248px_1fr] gap-[8px] py-[20px] lg:py-[24px] w-full border-b border-[#e5e8eb]">
                ...
                <div className="text-right lg:text-left">
                  <div className="font-['Pretendard'] font-semibold leading-[0] not-italic text-[#4e5968] text-[20px]">
                    <p className="block leading-[1.6] whitespace-pre">3.4%</p>
                  </div>
                  <div className="mt-[4px] font-['Pretendard'] font-normal leading-[0] not-italic text-[#6b7684] text-[17px]">
          ...
          <div className="flex flex-col gap-[40px] w-full">
            ...
            <div className="w-full border-t border-[#e5e8eb]">
              ...
              <div className="hidden lg:grid grid-cols-[248px_248px_248px_1fr] gap-[8px] py-[24px] w-full border-b border-[#e5e8eb]">
                <div></div>
                <div className="font-['Pretendard'] font-medium leading-[0] not-italic text-[#8b95a1] text-[17px] text-left text-nowrap pr-[24px]">
                  <p className="block leading-[1.6] whitespace-pre">기본 수수료</p>
                </div>
                <div className="flex flex-row gap-[8px] items-center pr-[24px]">
                  <div className="font-['Pretendard'] font-medium leading-[0] not-italic text-[#8b95a1] text-[17px] text-left text-nowrap">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[248px_248px_248px_1fr] gap-[8px] py-[20px] lg:py-[24px] w-full border-b border-[#e5e8eb]">
                <div className="font-['Pretendard'] font-semibold leading-[0] not-italic text-[#4e5968] text-[20px] text-left text-nowrap pr-[24px]">
                ...
                <div className="lg:hidden grid grid-cols-[1fr_auto] gap-[8px] mb-[8px]">
                  <div className="font-['Pretendard'] font-medium text-[#8b95a1] text-[17px] text-left">기본 수수료</div>
                  <div className="font-['Pretendard'] font-semibold text-[#4e5968] text-[20px] text-right">4.0%</div>
                </div>
                <div className="lg:hidden grid grid-cols-[1fr_auto] gap-[8px] mb-[8px]">
                  <div className="flex gap-[8px] items-center">
                    <div className="font-['Pretendard'] font-medium text-[#8b95a1] text-[17px] text-left">고정 수수료</div>
                    <QuestionIcon tooltipText="결제 건당 고정으로 부과되는 수수료입니다" />
                  </div>
                  <div className="font-['Pretendard'] font-semibold text-[#4e5968] text-[20px] text-right">+ 건당 0.3 USD</div>
                </div>
                <div className="lg:hidden grid grid-cols-[1fr_auto] gap-[8px]">
                  <div className="flex gap-[8px] items-center">
                    <div className="font-['Pretendard'] font-medium text-[#8b95a1] text-[17px] text-left">환전・인출 수수료</div>
                    <QuestionIcon tooltipText="해외 결제 수익금을 원화로 환전하거나 인출할 때 부과되는 수수료입니다" />
                  </div>
                  <div className="font-['Pretendard'] font-semibold text-[#4e5968] text-[20px] text-right">+ 1.94%</div>
                </div>

                {/* 데스크탑: 가로 배치 */}
                <div className="hidden lg:block font-['Pretendard'] font-semibold leading-[0] not-italic text-[#4e5968] text-[20px] text-left pr-[24px]">
