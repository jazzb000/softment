      ...
      <div className="relative z-0 shrink-0 w-full">
        <div className="flex flex-row items-center justify-center overflow-hidden lg:overflow-visible relative size-full">
          <div className="box-border content-stretch flex flex-row items-center justify-center px-5 lg:px-[390px] py-16 lg:py-[160px] relative w-full max-w-[1440px] mx-auto">
            ...
            {/* HeroText1 */}
            <div className="box-border content-stretch flex flex-col gap-6 lg:gap-[40px] items-center justify-center relative shrink-0">
              <div className="font-['Pretendard'] font-bold leading-[0] not-italic relative shrink-0 text-[#ffffff] lg:text-5xl text-3xl text-center text-nowrap">
                <p className="block leading-[1.3] whitespace-pre">
                  자체 간편결제,
                  <br aria-hidden="true" />
                  브랜드페이로 지금 시작해보세요
              ...
              {/* Frame1370 */}
              <div className="box-border content-stretch flex flex-row gap-4 lg:gap-[20px] items-center justify-center lg:justify-start p-[0px] relative shrink-0">
                <div
                  className="box-border content-stretch flex flex-row h-[49px] items-center justify-center px-[14px] py-[11px] relative rounded-xl shrink-0 cursor-pointer"
                  onMouseEnter={() => setIsUnderWhiteHovered(true)}
                  onMouseLeave={() => setIsUnderWhiteHovered(false)}
                  style={{ backgroundColor: isUnderWhiteHovered ? '#e5e8eb' : '#ffffff' }}
                >
                  <div
                    className="font-['Pretendard'] font-semibold leading-[0] not-italic relative shrink-0 text-[17px] text-left text-nowrap"
                    style={{ color: isUnderWhiteHovered ? '#b0b8c1' : '#8b95a1' }}
                  >
                ...
                <div
                  className="box-border content-stretch flex flex-row h-[49px] items-center justify-center px-[14px] py-[11px] relative rounded-xl shrink-0 cursor-pointer"
                  onMouseEnter={() => setIsUnderPrimaryHovered(true)}
                  onMouseLeave={() => setIsUnderPrimaryHovered(false)}
                  style={{ backgroundColor: isUnderPrimaryHovered ? '#2272EB' : '#3182f6' }}
                >
